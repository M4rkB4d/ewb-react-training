...
export const accountSchema = z
  .object({
    ...
    balance: z.number().int().nonnegative('Balance cannot be negative'), // centavos
    availableBalance: z.number().int().nonnegative('Available balance cannot be negative'), // centavos
