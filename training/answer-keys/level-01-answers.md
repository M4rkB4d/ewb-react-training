...
export const accountSchema = z
  .object({
    ...
    balance: z.number().int().nonnegative('Balance cannot be negative'), // pesos (whole number at this stage — centavos model starts in B03)
    availableBalance: z.number().int().nonnegative('Available balance cannot be negative'), // pesos (whole number at this stage)
