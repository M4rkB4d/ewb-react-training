...
**Branch:** `level-02-start`

---

## About This Level

Your first codebase. The portal code is pre-built — explore it while reading the guides, and run the exercise tests to verify your understanding.
